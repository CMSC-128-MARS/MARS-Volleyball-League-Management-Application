# MARS Volleyball League Management Frontend

This is the **frontend** of the **MARS Volleyball League Management Application**.  
It provides a user interface to manage teams, players, schedules, and other league operations.
...
- **Styling:** CSS (or optional frameworks like Bootstrap, Tailwind)
