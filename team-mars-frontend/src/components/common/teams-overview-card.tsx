        ...
        <Card className="w-full h-full border border-border shadow-md">
            <CardContent className="space-y-[24px] h-full flex flex-col">
                ...
                <div className="flex justify-between items-end">
                        ...
                        <Button variant="default" size="sm" className="bg-primary text-primary-foreground cursor-pointer">
                            Manage
                    ...
                    <div className="space-y-0">
                        <div className="overflow-x-auto">
                            ...
                            {teams.length > 0 ? teams.map((team) => (
                                <div key={team.team_id} className="grid grid-cols-12 gap-4 py-4 border-b border-border last:border-b-0 hover:bg-muted/30 transition-colors min-w-[600px]">
                                    <div className="col-span-2">
                                        <span className="pg1 text-foreground ">
                                            {team.team_id}
                                        </span>
                                    </div>
                                    <div className="col-span-5">
                                    ...
                                    <div className="col-span-1 flex justify-end">
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <Button variant="ghost" size="icon-sm" className="h-6 w-6 hover:bg-muted-foreground/20 cursor-pointer">
                                                    <RectangleEllipsis />
                                                    {/* Add onclick path when team page form is made */}
                                                </Button> 
                                            </TooltipTrigger>
                                            <TooltipContent side="top" align="center" sideOffset={4} className="[&>div]:hidden bg-muted text-foreground border border-foreground/30">
                                                <p>Team details</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </div>
